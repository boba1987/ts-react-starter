...
TypeScript React Starter is a comprehensive starter kit for rapid application development using React. It offers a rich development experience including:
...
| [Mocha](http://mochajs.org) | Automated tests with [Chai](http://chaijs.com/) for assertions and [Cheerio](https://www.npmjs.com/package/cheerio) for DOM testing without a browser using Node. |
|  [ts-node](https://github.com/TypeStrong/ts-node)  | TypeScript execution environment and REPL for node. Used with mocha to transpile TypeScript.    |
